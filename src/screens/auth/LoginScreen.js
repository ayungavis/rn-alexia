...
import { postLogin } from 'library/redux/actions/auth';
		...
		return(
			<Container style={styles.container}>
				...
				<View style={styles.background}>
					<TouchableOpacity style={styles.floatingBack} onPress={() => this.handleBack()}>
						<FontAwesome5 name='chevron-left' size={25} color={colors.primary} />
					</TouchableOpacity>
						...
						<View style={styles.formLayout}>
							<Form style={styles.form}>
								<Item stackedLabel>
									...
									<Input style={styles.input} autoFocus={true} onChangeText={(text) => this.setState({ email: text })} />
								</Item>
								<Item stackedLabel>
